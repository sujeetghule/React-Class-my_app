...
function UseReducer4() {
    ...
    return (
        <div>
            ...
            <button className='btn btn-warning m-2' onClick={() => { dispatch1({ type: "increment" }) }}>Increment</button>
            <button className='btn btn-warning m-2' onClick={() => { dispatch1({ type: "decrement" }) }}>Decrement</button>
            <button className='btn btn-warning m-2' onClick={() => { dispatch1({ type: "reset" }) }}>Reset</button>
            <h1>{count2.firstCounter}</h1>
            <button className='btn btn-warning m-2' onClick={() => { dispatch2({ type: "increment" }) }}>Increment</button>
            <button className='btn btn-warning m-2' onClick={() => { dispatch2({ type: "decrement" }) }}>Decrement</button>
